...
<script>
    async function enviarFormulario(event) {
        ...
        try {
            ...
            alert('Token generado: ' + result.token);
        } catch (error) {
...
<body>
    ...
    <h1>Formulario</h1>
    <div>
        <a href="../pqrs.html"><button class="botón_volver">Volver</button></a>
    </div>
    <div class="cuadro_formulario">
        <div class="fila">
            <div class="mover">
                    <label for="Nombre">Nombre</label>
                    <input type="text" name="Nombre" id="Nombre" autofocus value="<?= isset($Nombre) ? $Nombre : "" ?>" class="form-control form-control-sm rounded-0" required>
                </div>
                <br>
            <div class="mover_0">
                    <label for="Apellido">Apellido</label>
                    <input type="text" name="Apellido" id="Apellido" value="<?= isset($Apellido) ? $Apellido : "" ?>" class="form-control form-control-sm rounded-0" required>
                </div>
                <br>
            <div class="mover_1">
                    <label for="Correo_Electronico">Correo Electronico</label>
                    <input type="email" name="Correo_Electronico" id="Correo_Electronico" value=" <?= isset($Correo_Electronico) ? $Correo_Electronico : "" ?>"class="form-control form-control-sm rounded-0" required>
                </div>
                </div>
                <br>
        <div class="fila">
            <div class="mover_2">
                    <label for="Documento_de_identificación">Documento de Identificación</label>
                    <input type="text" name="Documento_de_identificación" id="Documento_de_identificación" value=" <?= isset($Documento_de_identificación) ? $Documento_de_identificación : "" ?>"class="form-control form-control-sm rounded-0">
                </div>
                <br>
            <div class="mover_3">
                    <label for="Tipo_de_Documento">Tipo de Documento</label>
                    <select name="Tipo_de_Documento" id="Tipo_de_Documento " value="<?= isset($Tipo_de_Documento) ? $Tipo_de_Documento : "" ?>" class="form-control form-control-sm rounded-0" required>
                        <option <?= isset($Tipo_de_Documento ) && $Tipo_de_Documento == 'Tarjeta de Identidad' ? 'selected' : '' ?>>Tarjeta de Identidad</option>
                        <option <?= isset($Tipo_de_Documento ) && $Tipo_de_Documento == 'Cédula de Ciudadanía' ? 'selected' : '' ?>>Cédula de Ciudadanía</option>
                        <option <?= isset($Tipo_de_Documento ) && $Tipo_de_Documento == 'Cedula Extranjeria' ? 'selected' : '' ?>>Cedula Extranjeria</option>
                    </select>
                </div>
                </div>
                <br><br>
                <div class="mover_4">
                    ...
                    <input  class="control_label" type="date" name="Fecha_de_Nacimiento" id="Fecha_de_Nacimiento" value="<?= isset($Fecha_de_Nacimiento) ? $Fecha_de_Nacimiento : "" ?>" class="form-control form-control-sm rounded-0" required>
                </div>
                <br> 
        <div class="fila">
            <div class="mover_5">
                    <label for="Género">Género</label>
                    <select name="Género" id="Género" value="<?= isset($Género) ? $Género : "" ?>" class="form-control form-control-sm rounded-0" required>
                        <option <?= isset($Género) && $Género == 'Masculino' ? 'selected' : '' ?>>Masculino</option>
                        <option <?= isset($Género) && $Género == 'Femenino' ? 'selected' : '' ?>>Femenino</option>
                        <option <?= isset($Género) && $Género == 'LGBTQ+' ? 'selected' : '' ?>>Lgbtq+</option>
                    </select>
                </div>
                <br>
            <div class="mover_6">
                    <label for="Teléfono">Teléfono</label>
                    <input type="text" name="Teléfono" id="Teléfono" value="<?= isset($Teléfono) ? $Teléfono : "" ?>" class="form-control form-control-sm rounded-0" required>
                </div>
                </div>
                <br>
            <div class="mover_7">
                    <label for="Departamento">Departamento</label>
                    <input list="browsers" type="text" name="Departamento" id="Departamento" value="<?= isset($Departamento) ? $Departamento : "" ?>" class="form-control form-control-sm rounded-0" required>
                    <datalist id="browsers">
                        <option <?= isset($Departamento) && $Departamento == 'Amazonas' ? 'selected' : '' ?>>Amazonas</option>
                        <option <?= isset($Departamento) && $Departamento == 'Antioquía' ? 'selected' : '' ?>>Antioquía</option>
                        <option <?= isset($Departamento) && $Departamento == 'Arauca' ? 'selected' : '' ?>>Arauca</option>
                        <option <?= isset($Departamento) && $Departamento == 'Atlántico' ? 'selected' : '' ?>>Atlántico</option>
                        <option <?= isset($Departamento) && $Departamento == 'Bolívar' ? 'selected' : '' ?>>Bolívar</option>
                        <option <?= isset($Departamento) && $Departamento == 'Boyacá' ? 'selected' : '' ?>>Boyacá</option>
                        <option <?= isset($Departamento) && $Departamento == 'Caldas' ? 'selected' : '' ?>>Caldas</option>
                        <option <?= isset($Departamento) && $Departamento == 'Caquetá' ? 'selected' : '' ?>>Caquetá</option>
                        <option <?= isset($Departamento) && $Departamento == 'Casanare' ? 'selected' : '' ?>>Casanare</option>
                        <option <?= isset($Departamento) && $Departamento == 'Cauca' ? 'selected' : '' ?>>Cauca</option>
                        <option <?= isset($Departamento) && $Departamento == 'Cesar' ? 'selected' : '' ?>>Cesar</option>
                        <option <?= isset($Departamento) && $Departamento == 'Chocó' ? 'selected' : '' ?>>Chocó</option>
                        <option <?= isset($Departamento) && $Departamento == 'Córdoba' ? 'selected' : '' ?>>Córdoba</option>
                        <option <?= isset($Departamento) && $Departamento == 'Cundinamarca' ? 'selected' : '' ?>>Cundinamarca</option>
                        <option <?= isset($Departamento) && $Departamento == 'Guainía' ? 'selected' : '' ?>>Guainía</option>
                        <option <?= isset($Departamento) && $Departamento == 'Guaviare' ? 'selected' : '' ?>>Guaviare</option>
                        <option <?= isset($Departamento) && $Departamento == 'Huila' ? 'selected' : '' ?>>Huila</option>
                        <option <?= isset($Departamento) && $Departamento == 'La Guajira' ? 'selected' : '' ?>>La Guajira</option>
                        <option <?= isset($Departamento) && $Departamento == 'Magdalena' ? 'selected' : '' ?>>Magdalena</option>
                        <option <?= isset($Departamento) && $Departamento == 'Meta' ? 'selected' : 'Meta' ?>>Meta</option>
                        <option <?= isset($Departamento) && $Departamento == 'Nariño' ? 'selected' : '' ?>>Nariño</option>
                        <option <?= isset($Departamento) && $Departamento == 'Norte de Santander' ? 'selected' : '' ?>>Norte de Santander</option>
                        <option <?= isset($Departamento) && $Departamento == 'Putumayo' ? 'selected' : '' ?>>Putumayo</option>
                        <option <?= isset($Departamento) && $Departamento == 'Quindío' ? 'selected' : '' ?>>Quindío</option>
                        <option <?= isset($Departamento) && $Departamento == 'Risaralda' ? 'selected' : '' ?>>Risaralda</option>
                        <option <?= isset($Departamento) && $Departamento == 'San Andrés y Providencia' ? 'selected' : '' ?>>San Andrés y Providencia</option>
                        <option <?= isset($Departamento) && $Departamento == 'Santander' ? 'selected' : '' ?>>Santander</option>
                        <option <?= isset($Departamento) && $Departamento == 'Sucre' ? 'selected' : '' ?>>Sucre</option>
                        <option <?= isset($Departamento) && $Departamento == 'Tolima' ? 'selected' : '' ?>>Tolima</option>
                        <option <?= isset($Departamento) && $Departamento == 'Valle del Cauca' ? 'selected' : '' ?>>Valle del Cauca</option>
                        <option <?= isset($Departamento) && $Departamento == 'Vaupés' ? 'selected' : '' ?>>Vaupés</option>
                        <option <?= isset($Departamento) && $Departamento == 'Vichada' ? 'selected' : '' ?>>Vichada</option>
                    </select>
                </div>
                <br>
        <div class="fila">
                <div class="mover_8">
                    ...
                    <select name="Municipio" id="Municipio" value="<?= isset($Municipio) ? $Municipio : "" ?>" class="form-control form-control-sm rounded-0" required>
            ...
            <div class="mover_9">
                    ...
                    <input name="Dirección" id="Dirección" class="form-control form-control-sm rounded-0" required><?= isset($Dirección) ? $Dirección : "" ?></input> 
                </div>
                <br>
                <div class="mover_10">
                <label class="mensaje" for="Observacion">Observacion</label>
                <div>
                <textarea  class="estilotextarea" name="Observacion" id="Observacion" placeholder=" Escribe aquí tu inquietud." rows="12" cols="86" ></textarea>
                </div>
        </div>
    </div>   
        <form class="formulario" method="POST" action="guardar_documento.php" enctype="multipart/form-data" onsubmit="enviarFormulario(event)">
